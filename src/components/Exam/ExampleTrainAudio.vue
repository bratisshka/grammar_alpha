    ...
    <div>
            ...
            <div class="gr-card-body h100">
                <div class="d-flex h100">
                    <div class="d-flex align-items-center justify-content-center h100 flex-grow-1">
                        <div class="image-wrapper" @click="playAudio(current_example.id, 'en', current_example.card)">
        ...
        <div class="card mb-3">
            <div class="gr-card-body h100">
                <div class="d-flex h100">
                    <div class="d-flex align-items-center justify-content-center h100 flex-grow-1">
                        <div class="image-wrapper" @click="playAudio(current_example.id, 'ru', current_example.card)">
                            <i class="material-icons">
                                volume_up
                            </i>
                        </div>
